<x-app-layout>
    <div class="container py-8 grid grid-cols-5">
        <aside>
            <h1 class="font-bold text-lg mtb-4">Edicion del curso</h1>
            ...
            <div class="card-body text-gray-600">
                ...
                {!! Form::model($course, ['route' => ['instructor.courses.update', $course], 'method' => 'put', 'files' => true]) !!}
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        ...
                        <div>
                            {!! Form::label('prices_id', 'Precio') !!}
                            {!! Form::select('prices_id', $prices, null, ['class' => 'form-input block w-full mt-1']) !!}
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            <p class="mb-2">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Voluptatum adipisci eaque non culpa 
                                at dicta obcaecati aspernatur maiores reprehenderit illo cupiditate aut ad, fugit quas enim, 
                                illum dolor dolores harum.</p>
