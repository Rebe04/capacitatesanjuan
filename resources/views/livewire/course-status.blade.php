<div class="mt-8">
    <div class="container grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div class="lg:col-span-2">
            ...
            <h1 class="text-3xl text-gray-600 font-bold pt-2">{{$current->name}}</h1>
            ...
            <div class="flex justify-between mt-4">
                ...
                @if ($current->resource)
                    <div wire:click="download" class="flex item-center text-gray-600 cursor-pointer">
            ...
            <div class="card mt-2">
                <div class="card-body flex text-gray-500 font-bold">
                    @if ($this->previous)
                    <a wire:click="changeLesson({{$this->previous}})" class="cursor-pointer"><i class="fas fa-angle-left mr-2"></i>Tema anterior</a>
                    @endif
                    
                    @if ($this->next)
                    <a wire:click="changeLesson({{$this->next}})" class="ml-auto cursor-pointer">Siguiente tema <i class="fas fa-angle-right ml-2"></i></a>
                    @endif
                </div>
            </div>
            ...
            <div class="card-body">
                ...
                <ul>
                    ...
                    <li class="text-gray-600 mb-4">
                        <a class="font-bold text-base inline-block mb-2" href="">
                            {{$section->name}}
                        </a>
                        <ul>
