        ...
        <article class="mb-4">
            ...
            <div class="flex">
                <figure class="mr-4">
                    ...
                    <img class="h-12 w-12 object-cover rounded-full shadow-lg" src=" {{$item->profile_photo_url}} " alt="Foto de perfil">
                    @endforeach
                </figure>
                <textarea wire:model="comment" class="form-input w-full" rows="3" placeholder="Ingrese una reseña del curso"></textarea>
            </div>

            <div class="flex ml-16 pt-2 items-center">
        ...
        <div class="card-body">
            ...
            @foreach ($course->reviews as $review)
                <article class="flex mb-4 text-gray-800">
                    <figure class="mr-4">
                        <img class="h-12 w-12 object-cover rounded-full shadow-lg" src=" {{$review->user->profile_photo_url}} " alt="Foto de perfil">
                    </figure>
