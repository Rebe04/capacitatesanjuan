    ...
    <section class="bg-gray-700 py-12 mb-12">
        <div class="container grid grid-cols-1 lg:grid-cols-2 gap-6">
            <figure>
                ...
                @else
                    <img class="h-60 w-full object-cover" src="https://image.freepik.com/foto-gratis/estudiante-clase-mirando-curso_23-2148888810.jpg" alt="">
                @endif
            </figure>
            ...
            <section class="card mb-4">
                <div class="card-body">
                    <div class="flex items-center">
                        <img class="h-12 w-12 object-cover rounded-full" src="{{$course->teacher->profile_photo_url}}" alt="{{$course->teacher->name}}">
                        <div class="ml-4">
                    ...
                    <a href=" {{route('admin.courses.observation', $course)}} " class="btn btn-danger w-full block text-center mt-4">Denegar curso</a>
                </div>
            </section>
        </div>
    </div>
